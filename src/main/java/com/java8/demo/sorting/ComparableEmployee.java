...
public class ComparableEmployee implements Comparable<ComparableEmployee> {
	...
	@Override
	public int compareTo(ComparableEmployee comparableEmployee) {
		// return this.name.compareTo(comparableEmployee.name);

		Double compareSalary = ((ComparableEmployee) comparableEmployee).getSalary();
